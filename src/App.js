    ...
    <div className="App">
      <header className="App-header">
        ...
        <div className="welcome-content">
          ...
          <span className="menu">
            <a href="experience" class="button blue-background disabled" alt="Experience">Experience</a>
            <a href="https://github.com/jazperez" class="button purple-background" alt="Github profile">Github</a>
            <a href="https://www.linkedin.com/in/jazmin-perez24/" class="button pink-background" alt="Linkedin profile">Linkedin</a>
          </span>
